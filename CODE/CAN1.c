...
**          RXCAN pin                                      : PM0_RXD2_RXCAN
**          RXCAN pin signal                               : 
**          TXCAN pin                                      : PM1_TXD2_TXCAN
**          TXCAN pin signal                               : 
**          Wake up                                        : 
**          Wake up                                        : Enabled
**          Interrupt                                      : Vcanwkup
**          Wake interrupt priority                        : 1
**          ISR name                                       : CanWakeUpInt
**          Error                                          : 
...
void CAN1_Init(void)
{
  ...
  /* CANBTR0: SJW1=0,SJW0=0,BRP5=0,BRP4=0,BRP3=0,BRP2=0,BRP1=1,BRP0=0 */
  setReg8(CANBTR0, 0x02U);              
  ...
  /* CANRIER: WUPIE=1,CSCIE=0,RSTATE1=0,RSTATE0=0,TSTATE1=0,TSTATE0=0,OVRIE=0,RXFIE=1 */
  setReg8(CANRIER, 0x81U);              
