...
**     Abstract  :
**         This component "MC9S12G128_48" implements properties, methods,
...
/*
** ===================================================================
**     Method      :  Cpu_Cpu_Interrupt (component MC9S12G128_48)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_DisableInt (component MC9S12G128_48)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_EnableInt (component MC9S12G128_48)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetStopMode (component MC9S12G128_48)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  Cpu_SetWaitMode (component MC9S12G128_48)
**
**     Description :
...
/*
** ===================================================================
**     Method      :  _EntryPoint (component MC9S12G128_48)
**
**     Description :
...
void _EntryPoint(void)
{
  ...
  /* ### MC9S12G128_48 "Cpu" init code ... */
  /*  PE initialization code after reset */
  /* MMCCTL1: ??=0,??=0,??=0,??=0,??=0,??=0,??=0,NVMRES=0 */
  setReg8(MMCCTL1, 0x00U);              
  /* PKGCR: APICLKS7=0,??=0,??=0,??=0,??=0,PKGCR2=0,PKGCR1=1,PKGCR0=1 */
  setReg8(PKGCR, 0x03U);                
...
/*
** ===================================================================
**     Method      :  PE_low_level_init (component MC9S12G128_48)
**
**     Description :
...
void PE_low_level_init(void)
{
  ...
  /* PTS: PTS2=0 */
  clrReg8Bits(PTS, 0x04U);              
  /* WOMS: WOMS2=0 */
  clrReg8Bits(WOMS, 0x04U);             
  /* PERS: PERS2=0 */
  clrReg8Bits(PERS, 0x04U);             
  /* DDRS: DDRS2=1 */
  setReg8Bits(DDRS, 0x04U);             
  ...
  /* ATDDIEN: IEN5=0 */
  clrReg16Bits(ATDDIEN, 0x20U);         
  /* ### MC9S12G128_48 "Cpu" init code ... */
  /* ### Init_MSCAN "CAN1" init code ... */
  CAN1_Init();
  /* ### BitIO "TJA1043_STB" init code ... */
  Shadow_S &= 0xFBU;                   /* Initialize pin shadow variable bit */
  /* ### Init_RTI "rti" init code ... */
  rti_Init();
  /* ###  "AD_BATT" init code ... */
  AD_BATT_Init();
