...
const DIDNode DIDS[] = {
    {0xF193, 2 ,  NULL , EEPROM_DID , NULL , READONLY , HARDWARE_VERSION_ADDRESS},//硬件版本号    
    {0xF195, 2 ,  NULL , EEPROM_DID , NULL , READONLY , SOFTWARE_VERSION_ADDRESS},//软件版本号
    {0xF190, 17 ,  NULL , EEPROM_DID , NULL , READONLY , VIN_ADDRESS},//VIN
    {0xF18A, 7 ,  NULL , EEPROM_DID , NULL , READONLY , SUPPLIER_CODE_ADDRESS},//供应商编号
    {0xF1CB, 4 ,  NULL , EEPROM_DID , NULL , READONLY , PART_NUMBER_ADDRESS},//SGMW P/N
    {0xF191, 4 ,  NULL , EEPROM_DID , NULL , READONLY , SGMW_HARD_NUM_ADDRESS},//SGMW ECU 硬件号
    {0xF188, 4 ,  NULL , EEPROM_DID , NULL , READONLY , SGMW_SOFT_NUM_ADDRESS},//SGMW ECU 软件号
    {0xF180, 4 ,  FBL_SOFT_VERSION , REALTIME_DID , NULL , READONLY , 0},////BOOT版本号0x13C4
